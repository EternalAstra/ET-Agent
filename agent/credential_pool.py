...
def _seed_from_singletons(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    if provider == "anthropic":
        ...
        # that masquerade.  Prefer ~/.et-agent/.env over os.environ for the
        ...
        # MiniMax OAuth tokens live in ~/.et-agent/auth.json providers.minimax-oauth.
...
def _seed_from_env(provider: str, entries: List[PooledCredential]) -> Tuple[bool, Set[str]]:
    ...
    # Prefer ~/.et-agent/.env over os.environ — the user's config file is the
    ...
    # won't be re-seeded from the user's shell environment or ~/.et-agent/.env.
    ...
    if provider == "openrouter":
        # Prefer ~/.et-agent/.env over os.environ

#!/usr/bin/env python3
"""Google Workspace OAuth2 setup for ET-Agent.
...
TOKEN_PATH = ET_AGENT_HOME / "google_token.json"
CLIENT_SECRET_PATH = ET_AGENT_HOME / "google_client_secret.json"
PENDING_AUTH_PATH = ET_AGENT_HOME / "google_oauth_pending.json"
...
def install_deps():
    ...
    print("  pip install 'et-agent[google]'")

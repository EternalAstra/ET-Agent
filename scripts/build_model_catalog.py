...
``https://et-agent.nousresearch.com/docs/api/model-catalog.json``
"""
...
# Ensure ET_AGENT_HOME is set for imports that touch it at module level.
os.environ.setdefault("ET_AGENT_HOME", os.path.join(os.path.expanduser("~"), ".et-agent"))
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "et-agent repo",
            "docs": "https://et-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {

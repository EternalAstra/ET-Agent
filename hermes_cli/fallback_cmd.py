...
Storage: ``fallback_providers`` in ``~/.et-agent/config.yaml`` (top-level, list of
...
def cmd_fallback_list(args) -> None:  # noqa: ARG001
    ...
    print("  Docs: https://et-agent.nousresearch.com/docs/user-guide/features/fallback-providers")
    print()

# ET-Agent Has Had "Routines" Since March
...
hermes cron create "every 1h" \
  ...
  --script ~/.et-agent/scripts/watch-site.py \
...
ET-Agent is open source and free. The automation infrastructure — cron scheduler, webhook platform, skill system, multi-platform delivery — is built in.

```bash
pip install et-agent
hermes setup
```
...
Full automation blueprints gallery: [et-agent.nousresearch.com/docs/reference/automation-blueprints-catalog](https://et-agent.nousresearch.com/docs/reference/automation-blueprints-catalog)

Documentation: [et-agent.nousresearch.com](https://et-agent.nousresearch.com)

GitHub: [github.com/NousResearch/et-agent](https://github.com/NousResearch/et-agent)

---

*ET-Agent is built by [Nous Research](https://nousresearch.com). Open source, model-agnostic, runs on your infrastructure.*

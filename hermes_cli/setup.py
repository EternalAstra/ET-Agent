"""
Interactive setup wizard for ET-Agent.
...
_DOCS_BASE = "https://et-agent.nousresearch.com/docs"
...
def _setup_tts_provider(config: dict):
    ...
    if selected == "nous-openai":
        ...
        if get_env_value("VOICE_TOOLS_OPENAI_KEY") or get_env_value("OPENAI_API_KEY"):
            print_warning(
                "Direct OpenAI credentials are still configured and may take precedence until removed from ~/.et-agent/.env."
            )
...
def _profile_name_from_hermes_home(hermes_home) -> str | None:
    """Return the active profile name when ET_AGENT_HOME is a profile dir."""
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://et-agent.nousresearch.com/docs/user-guide/messaging/slack/")
    print()
...
def _write_slack_manifest_and_instruct():
    """Generate the Slack manifest, write it under ET_AGENT_HOME, and print
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://et-agent.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://et-agent.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
...
def run_setup_wizard(args):
    ...
    print(
        color(
            "│             ⚕ ET-Agent Setup Wizard                │", Colors.MAGENTA
        )
    )
    print(
        color(
    ...
    print(
        color(
            "│  Let's configure your ET-Agent installation.       │", Colors.MAGENTA
        )
    )
    print(
        color(

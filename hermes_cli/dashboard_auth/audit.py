...
Profile-aware location: ``$ET_AGENT_HOME/logs/dashboard-auth.log``.
...
def _resolve_log_path() -> Path:
    """``$ET_AGENT_HOME/logs/dashboard-auth.log`` with the standard fallback.
    ...
    """
    home = os.environ.get("ET_AGENT_HOME") or str(Path.home() / ".et-agent")

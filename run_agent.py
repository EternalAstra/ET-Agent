...
class AIAgent:
    ...
    _TOOL_CALL_ARGUMENTS_CORRUPTION_MARKER = (
        "[et-agent: tool call arguments were corrupted in this session and "
    ...
    def _codex_silent_hang_hint(self, model: Optional[str] = None) -> Optional[str]:
        ...
        et-agent #21444 for the symptom history.  The upstream backend
        ...
        return (
            ...
            "See et-agent#21444 for symptom history."
        )
    ...
    def _save_session_log(self, messages: List[Dict[str, Any]] = None):
        ...
        whose external tooling consumes ``~/.et-agent/sessions/session_{sid}.json``
    ...
    def _format_file_mutation_failure_footer(cls, failed: Dict[str, Dict[str, Any]]) -> str:
        ...
        (e.g. ``~/.et-agent/config.yaml``) to a messaging channel (#35584).
        """
        if not failed:
            return ""
        lines = [

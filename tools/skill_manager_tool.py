...
~/.et-agent/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.et-agent/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.et-agent/skills/) first, then any
...
def _find_skill_in_other_profiles(name: str) -> List[Tuple[str, Path]]:
    ...
    # Default profile (~/.et-agent/skills) — only consider when active is non-default.
    ...
    # All named profiles (~/.et-agent/profiles/*/skills)

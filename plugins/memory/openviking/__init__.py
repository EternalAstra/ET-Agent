...
def _openviking_server_log_path() -> Path:
    try:
        ...
        home = Path(os.environ.get("ET_AGENT_HOME", "")).expanduser() if os.environ.get("ET_AGENT_HOME") else Path.home() / ".et-agent"
...
class OpenVikingMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        # against a concurrent increment. See et-agent#28296 review.
    ...
    def on_session_switch(
        ...
        **kwargs,
        ...
        and memory extraction never fires for it. See et-agent#28296.

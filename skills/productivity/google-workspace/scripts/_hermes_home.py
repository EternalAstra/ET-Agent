"""Resolve ET_AGENT_HOME for standalone skill scripts.
...
instead of duplicating the ``ET_AGENT_HOME = Path(os.getenv(...))`` pattern.
"""
...
try:
    ...
    def get_hermes_home() -> Path:
        ...
        return Path(val) if val else Path.home() / ".et-agent"

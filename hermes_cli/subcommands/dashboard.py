...
def build_dashboard_parser(
    ...
    dashboard_parser = subparsers.add_parser(
        ...
        description="Launch the ET-Agent web dashboard for managing config, API keys, and sessions",
    )
    ...
    # client with Nous Portal and write the client_id into ~/.et-agent/.env.
    ...
    dashboard_register_parser = dashboard_subparsers.add_parser(
        ...
        description=(
            ...
            "HERMES_DASHBOARD_OAUTH_CLIENT_ID into ~/.et-agent/.env, and prints "

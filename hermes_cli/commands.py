...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("reload-skills", "Re-scan ~/.et-agent/skills/ for newly installed or removed skills",
    ...
    CommandDef("update", "Update ET-Agent to the latest version", "Info"),
    CommandDef("version", "Show ET-Agent version", "Info", aliases=("v",)),
...
def slack_app_manifest(request_url: str = "https://et-agent.local/slack/commands") -> dict[str, Any]:

...
Or via $ET_AGENT_HOME/hindsight/config.json (profile-scoped), falling back to
...
def _load_config() -> dict:
    ...
    Resolution order:
      1. $ET_AGENT_HOME/hindsight/config.json  (profile-scoped)
...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._retain_context = "conversation between ET-Agent and the User"
    ...
    def save_config(self, values, hermes_home):
        """Write config to $ET_AGENT_HOME/hindsight/config.json."""
        import json
        from pathlib import Path
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "retain_context", "description": "Context label for retained memories", "default": "conversation between ET-Agent and the User"},
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._retain_context = self._config.get("retain_context", "conversation between ET-Agent and the User")

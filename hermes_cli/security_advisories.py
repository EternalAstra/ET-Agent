"""
Security advisory checker for ET-Agent.
...
ADVISORIES: tuple[Advisory, ...] = (
    Advisory(
        ...
        remediation=(
            ...
            "Rotate API keys in ~/.et-agent/.env (OpenRouter, Anthropic, OpenAI, "
...
# ``~/.et-agent/cache/advisory_banner_seen`` (a single line per advisory ID:

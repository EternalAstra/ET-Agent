...
class TestCreateProfile:
    ...
    def test_clone_all_excludes_default_infrastructure(self, profile_env):
        """--clone-all from default profile excludes et-agent, .worktrees,
        ...
        (default_home / "et-agent" / ".git").mkdir(parents=True)
        (default_home / "et-agent" / "venv" / "bin").mkdir(parents=True)
        (default_home / "et-agent" / "README.md").write_text("repo")
        ...
        assert not (profile_dir / "et-agent").exists()
...
class TestExportImport:
    ...
    def test_export_default_excludes_infrastructure(self, profile_env, tmp_path):
        ...
        for d in ("et-agent", ".worktrees", "profiles", "bin",
        ...
        excluded_prefixes = [
            "default/et-agent", "default/.worktrees", "default/profiles",

...
# argparse runs (it sets ``ET_AGENT_HOME`` and strips itself from ``sys.argv``),
...
Examples:
    ...
    hermes -s et-agent-dev,github-auth
...
def build_top_level_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="hermes",
        description="ET-Agent - AI assistant with tool-calling capabilities",
    ...
    _inherited_flag(
        ...
        action="store_true",
        default=False,
        help="Ignore ~/.et-agent/config.yaml and fall back to built-in defaults (credentials in .env are still loaded)",
    )
    _inherited_flag(
        parser,
        "--ignore-rules",
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with ET-Agent",
    )
    ...
    _inherited_flag(
        ...
        action="store_true",
        default=argparse.SUPPRESS,
        help="Ignore ~/.et-agent/config.yaml and fall back to built-in defaults (credentials in .env are still loaded). Useful for isolated CI runs, reproduction, and third-party integrations.",
    )
    _inherited_flag(
        chat_parser,
        "--ignore-rules",

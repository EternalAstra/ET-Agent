...
Skins are defined as YAML files in ~/.et-agent/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "ET-Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "ET-Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.et-agent/skins/
...
Drop a YAML file in ``~/.et-agent/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "ET-Agent",
            "welcome": "Welcome to ET-Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",

...
Built for [ET-Agent](https://github.com/NousResearch/et-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/et-agent/skills/creative/ascii-video`](https://github.com/NousResearch/et-agent/tree/main/skills/creative/ascii-video) via PR.
